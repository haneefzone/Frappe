...
# - Adds SQL + Redis autostart lines into /root/.bashrc
#
...
###########################################################
#  Auto-start MariaDB + Redis on root shell (bashrc)
###########################################################
...
echo "Configuring automatic SQL + Redis autostart in /root/.bashrc ..."
